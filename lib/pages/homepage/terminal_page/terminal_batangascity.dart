...
class TerminalBatangasCity extends StatefulWidget {
  @override
  _TerminalBatangasCityState createState() => _TerminalBatangasCityState();
}

class _TerminalBatangasCityState extends State<TerminalBatangasCity> {
              ...
              child: Card(
                ...
                child: Container(
                  ...
                  child: FlutterMap(
                    ...
                    options: MapOptions(
                      center: LatLng(13.789695134399413, 121.06252637084941),
                      zoom: _currentZoom,
                      minZoom: 10.0,
                      maxZoom: 18.0,
                    ),
                    children: [
                      ...
                      MarkerLayer(
                        markers: [
                          Marker(
                            point: LatLng(13.789695134399413, 121.06252637084941),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      subtitle: Text('Batangas City Grand Terminal',
