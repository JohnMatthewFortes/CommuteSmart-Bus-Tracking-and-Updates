...
class BusTwo extends StatefulWidget {
  @override
  _BusTwoState createState() => _BusTwoState();
}

class _BusTwoState extends State<BusTwo> {
                  ...
                  child: FlutterMap(
                    ...
                    children: [
                      ...
                      MarkerLayer(
                        markers: [
                          Marker(
                            point: LatLng(13.828981058374573, 120.99307999297955),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      subtitle: Text('Palico - Balayan Batangas Rd, Bauan, Batangas',
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      subtitle: Text('Slight to Moderate traffic',
                      style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.white),
                      ),
                    ),
                    ListTile(
