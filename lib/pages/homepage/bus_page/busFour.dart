...
class BusFour extends StatefulWidget {
  @override 
  _BusFourState createState() => _BusFourState();
}

class _BusFourState extends State<BusFour> {
                  ...
                  child: FlutterMap(
                    ...
                    children: [
                      ...
                      MarkerLayer(
                        markers: [
                          Marker(
                            point: LatLng(14.046508502165185, 120.69192065803196),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      subtitle: Text('Palico - Nasugbu Hwy, Tuy, Batangas',
                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      subtitle: Text('Light to Moderate rain',
                      style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.white),
                      ),
                    ),
                  ],
