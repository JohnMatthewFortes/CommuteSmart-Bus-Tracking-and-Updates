...
class BusThree extends StatefulWidget {
  @override
  _BusThreeState createState() => _BusThreeState();
}

class _BusThreeState extends State<BusThree> {
              ...
              child: Card(
                ...
                child: Container(
                  ...
                  child: FlutterMap(
                    ...
                    options: MapOptions(
                      center: LatLng(13.990070798347155, 120.72753873349374), //Palico - Balayan - Batangas Rd, Tuy, Batangas
                      zoom: _currentZoom,
                      minZoom: 10.0,
                      maxZoom: 18.0,
                    ),
                    children: [
                      ...
                      MarkerLayer(
                        markers: [
                          Marker(
                            point: LatLng(13.990070798347155, 120.72753873349374),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      subtitle: Text('Palico - Balayan - Batangas Rd, Tuy, Batangas',
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      subtitle: Text('Batangas City Grand Terminal to Nasugbu BSC Terminal',
                      style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.white),
                      ),
                    ),
                    ListTile(
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ListTile(
                      leading: Icon(Icons.traffic_sharp, color: Colors.white),
                      title: Text('Traffic', 
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.white),
                      ),
                      subtitle: Text('Normal traffic',
                      style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.white),
                      ),
                    ),
                    ListTile(
