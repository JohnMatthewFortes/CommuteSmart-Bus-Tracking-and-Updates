...
class BusOne extends StatefulWidget {
  @override
  _BusOneState createState() => _BusOneState();
}

class _BusOneState extends State<BusOne>{
              ...
              child: Card(
                ...
                child: Container(
                  ...
                  child: FlutterMap(
                    ...
                    options: MapOptions(
                      center: LatLng(13.92712679159231, 120.81281884969586),
                      zoom: _currentZoom,
                      minZoom: 10.0,
                      maxZoom: 18.0,
                    ),
                    children: [
                      ...
                      MarkerLayer(
                        markers: [
                          Marker(
                            point: LatLng(13.927246546079433, 120.81284030736752),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      subtitle: Text('Lemery Highway, Calaca',
                ...
                child: Column(
                  children: [
                    ...
                    ListTile(
                      ...
                      subtitle: Text('1 hour and 13 minutes',
                      style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.white),
                      ),
                    ),
                  ],
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      subtitle: Text('Heavier traffic than usual',
                      style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.white),
                      ),
                    ),
                    ListTile(
                      ...
                      subtitle: Text('Moderate to Heavy rain',
                      style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.white),
                      ),
                    ),
                  ],
